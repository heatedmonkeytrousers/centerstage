...
public class AutonomousFarFromBoard extends AutonomousOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d alignPose = new Pose2d(51, yScale * -19, Math.toRadians(90 * yScale));
        Pose2d backPose = new Pose2d(51, yScale * 81, Math.toRadians(90 * yScale));
        ...
        Trajectory board = drive.trajectoryBuilder(backPose)
                ...
                .addTemporalMarker(0, () -> {
                    super.shoulder.setShoulderPosition(0.5, -480);
                })
                .addTemporalMarker(1, () -> {
