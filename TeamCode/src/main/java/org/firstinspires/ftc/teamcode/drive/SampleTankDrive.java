...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "rearLeftDrive");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "rearRightDrive");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "frontRightDrive");
